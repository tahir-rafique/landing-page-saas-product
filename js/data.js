...
window.SITE_DATA = {
  services: [
    {
      ...
      titleAccent: ["primary", "primary"],
      theme: "light",
      illustration: "seo"
    },
    {
      title: ["Pay-per-click", "advertising"],
      titleAccent: ["white", "white"],
      theme: "primary",
      illustration: "ppc"
    },
    {
  ...
  process: [
    ...
    },
    {
      ...
      body: "We conduct comprehensive market research and analyze your competitors to develop a tailored strategy that aligns with your goals, audience, and brand voice."
    },
    {
      num: "03",
      title: "Implementation",
      body: "Our team executes the strategy across selected channels with attention to detail, ensuring every campaign is launched on time and on brand."
    },
    {
      num: "04",
      title: "Monitoring and Optimization",
      body: "We continuously monitor campaign performance, A/B test creative and targeting, and optimize toward the metrics that move your business."
    },
    {
      num: "05",
      title: "Reporting and Communication",
      body: "Receive transparent monthly reports with insights and clear next steps. We stay in close touch so there are no surprises."
    },
    {
      num: "06",
      title: "Continual Improvement",
      body: "Markets shift, so do we. We refine your strategy continually using performance data and emerging best practices."
    }
  ],
  ...
  testimonials: [
    ...
    {
      quote: "The Positivus team transformed our PPC strategy and we saw a measurable lift in qualified leads within the first quarter. Their reporting is clear and actionable.",
      name: "Amelia Reyes",
      role: "Growth Lead at Northwind"
    },
    {
      quote: "Their content team understands SaaS positioning. Posts now drive consistent inbound traffic and have shortened our sales cycle.",
      name: "Daniel Park",
      role: "Head of Marketing at Lumen"
    },
    {
      quote: "From SEO audits to ongoing optimization, Positivus has been a real extension of our team. Communication is fast and thoughtful.",
      name: "Priya Shah",
      role: "Founder, Verdant Apps"
    },
    {
      quote: "We doubled our organic conversions in six months. What stood out most was their willingness to challenge assumptions and test new approaches.",
      name: "Marcus Lee",
      role: "VP Marketing at Stellar"
    }
  ]
};
